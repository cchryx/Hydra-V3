            ...
            case "home":
                switch (autoStep_d) {
                    case 1:
                        ...
                        break;
                    case 10001:
                        if(autoTime.milliseconds() > 80 && outake.slidesPosition <= 0) {
...
//                        outake.rotateTarget = Values.OUTROTATE_GRAB;
//                        outake.pivotTarget = Values.OUTPIVOT_GRAB;
                        if (chamber && !pChamber && autoTime.milliseconds() > 0) {
