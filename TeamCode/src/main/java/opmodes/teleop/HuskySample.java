...
import components.HuskyControl;

@TeleOp(group = "Actual", name = "HuskySample")
public class HuskySample extends OpMode {
    ...
    public void loop() {
        ...
        boolean angle = gamepad1.options;
                ...
                switch (autoStep_i) {
                    case 1:
                        if (submersible && !pSubmersible && outake.pivotRPosition < 0.6) {
                            ...
                            if (angle && !pAngle) {
                                intake.rotateTarget = huskyControl.getServoPosition() - 0.47;
                            } else {
                                intake.rotateTarget = huskyControl.getServoPosition();
                            }
                            setAutoStep_i(2);
                        }
                        break;
