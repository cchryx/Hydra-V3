...
public class Values {
    ...
    // PIVOT
    public static double OUTPIVOT_MIN = 0;
    ...
    public static double OUTPIVOT_TRANSFER = 0.65;
    ...
    public static double INTURRET_DROP = 0.52;
    ...
    public static double INPIVOT_TRANSFER = 0.83;
    ...
    public static double INROTATE_SUB_G = 0.93;
    public static double INROTATE_DROP = 0.6;

    // ROTATE
    public static double HSLIDES_INIT = 0;
